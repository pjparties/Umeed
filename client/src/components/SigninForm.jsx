      ...
      <div className='form w-fit mx-auto mt-2 mb-3'>
        <form>
          <div className='email py-3'>
            <input className='rounded-lg border-gray-400 border-[0.1px] placeholder:font-light placeholder:text-sm placeholder:px-2' type="email" value={user.email} placeholder='Enter Username or Email' name="email" id="email" onChange={handleChange} />
          </div>
          <div classname='password'>
            <input className='rounded-lg border-gray-400 border-[0.1px] placeholder:font-light placeholder:text-sm placeholder:px-2' type="password" value={user.password} placeholder='Password' name="password" id="password" onChange={handleChange} />
          </div>
        </form>
