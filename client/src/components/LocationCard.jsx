...
const LocationCard = () => {
    ...
    return (
            <div className='Container flex flex-col h-screen items-end'>
                <div className=" h-[627px] w-[400px] donation bg-background border-gray-200 border-solid border-2 rounded-2xl my-10 flex mr-32 drop-shadow-2xl flex-col min-w-[334px] max-w-[432px]  min-h-[656px]">
