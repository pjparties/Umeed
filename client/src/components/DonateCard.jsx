...
const DonateCard = () => {
  ...
  return (
    <div className='Container flex flex-col h-screen items-end'>
      ...
      <div className="donation bg-background border-black border-solid rounded-2xl min-w-[334px] max-w-[432px] min-h-[600px] max-h-[656px] my-auto flex mr-32 drop-shadow-2xl flex-col">
