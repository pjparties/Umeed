...
export const GetinTouch = () => {
    return (
        <section class=" my-10 max-w-4xl p-6 mx-auto bg-getinTouch rounded-md shadow-md w-[420px] h-[514px]">
            ...
            <h2 class="  text-[56.75px] font-thin font-semibold text-black capitalize">Get in <span className='text-[56.75px] font-thin font-semibold text-getinTouch2'>Touch</span></h2>
